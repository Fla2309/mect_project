...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-02-2024 a las 01:29:42
...
--
-- Estructura de tabla para la tabla `jornada_usuarios`
--

CREATE TABLE `jornada_usuarios` (
  `id` int(11) NOT NULL,
  `id_usuario` int(11) NOT NULL,
  `basico_bloque1` int(11) DEFAULT NULL,
  `avanzado_bloque2` int(11) DEFAULT NULL,
  `pl_am` int(11) DEFAULT NULL,
  `contrato` varchar(100) DEFAULT '',
  `fuente` varchar(50) DEFAULT '',
  `estiramiento_av_b2` varchar(100) DEFAULT '',
  `estiramiento_pl_am` varchar(100) DEFAULT '',
  `cancion_cuna` varchar(100) DEFAULT '',
  `cancion_tercer_fin` varchar(100) DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Volcado de datos para la tabla `jornada_usuarios`
--

INSERT INTO `jornada_usuarios` (`id`, `id_usuario`, `basico_bloque1`, `avanzado_bloque2`, `pl_am`, `contrato`, `fuente`, `estiramiento_av_b2`, `estiramiento_pl_am`, `cancion_cuna`, `cancion_tercer_fin`) VALUES
(1, 1, 78, 78, 78, 'Yo soy un hombre amoroso, apasionado y seguro', 'Fuente de Valentía', 'Chen a Mimo', 'Leer a 5 hombres una carta dirigida a mi padre', 'Un millón de cicatrices - El canto del loco', 'Esto es lo que soy - Diego Torres');
...
(2, 2, 1, 'prueba 2_tareas.docx', '2022-08-26', 2),
...
--
-- Indices de la tabla `jornada_usuarios`
--
ALTER TABLE `jornada_usuarios`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `jornada_usuarios`
--
ALTER TABLE `jornada_usuarios`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
