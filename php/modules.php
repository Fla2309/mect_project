...
class Module extends DB
{
    ...
    {
        $query = $this->connect()->prepare('SELECT * FROM modulos WHERE id_modulo IN (SELECT id_modulo FROM modulos_grupos WHERE id_grupo = :group AND disponible > 0)');
                    ...
                    "<div class=\"row\" style=\"align-content: center;\">
                            <div id=\"mod_".$row['id_modulo']."\" class=\"col-sm px-5 py-5 mx-3 mt-4\" style=\"background-color: white;\">
                                <div class=\"p-1\">
                                    ...
                                    <p>0% completado</p>
                                    <button type=\"button\" class=\"btn btn-success\" style=\"width: 120px; text-align: left;\">
